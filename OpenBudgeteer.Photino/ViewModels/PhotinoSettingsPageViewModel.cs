...
/// <summary>
/// Photino-specific SettingsPageViewModel that uses file-based configuration services.
/// </summary>
public class PhotinoSettingsPageViewModel : ViewModelBase
{
    ...
    /// <summary>
    /// Sets how many records should be displayed on Home Page for Highest Incomes and Highest Expenses
    /// </summary>
    ...
    /// <summary>
    /// Reloads Data from config file and resets setting values
    /// </summary>
    ...
    /// <summary>
    /// Takes all defined Themes settings and stores them to the config file
    /// </summary>
    ...
    /// and deletes all Color settings from config file (except DarkMode setting)
    /// </summary>
    ...
    /// <summary>
    /// Takes all miscellaneous settings and stores them to the config file
    /// </summary>
    public async Task<ViewModelOperationResult> ApplySettingsAsync()
    {
        try
        {
            await _appSettingService.ApplySettingsAsync(new AppSettings(
                HomePageTopCount,
                TransactionPageSize,
                new ReportCounts(
