...
/// <summary>
/// Photino-specific ApexReportViewModel that uses file-based configuration services.
/// </summary>
public class PhotinoApexReportViewModel : ReportPageViewModel
{
    ...
    public PhotinoApexReportViewModel(
