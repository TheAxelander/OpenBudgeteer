...
public class EFCoreBudgetedTransactionRepository : IBudgetedTransactionRepository
{
    private DatabaseContext DatabaseContext { get; }
    
    public EFCoreBudgetedTransactionRepository(DatabaseContext databaseContext)
    {
